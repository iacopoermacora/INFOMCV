...
# First variant model, with dynamic lr
...
# Second variant model, with batch normalisation and reduced kernel size
class LeNet5Variant2(nn.Module):
    def __init__(self):
        ...
        # Fully connected layers
        self.fc1 = nn.Linear(16 * 6 * 6, 120)  # 4x4 image dimension after 2x2 pooling twice TODO: Check if it is fine changing to 4x4 instead than 5x5
        self.fc2 = nn.Linear(120, 84)
        self.fc3 = nn.Linear(84, 10)  # 10 output classes for Fashion-MNIST
...
# Third variant model, with batch normalisation, reduced kernel size and dropout
