...
# Second variant model, with ReLU activation and different kernel size
...
# Third variant model, with ReLU activation, different kernel size and one more convolutional layer
class LeNet5Variant3(nn.Module):
    def __init__(self):
        ...
        # Fully connected layers
        self.fc1 = nn.Linear(32 * 2 * 2, 120)  # 4x4 image dimension after 2x2 pooling twice
        self.fc2 = nn.Linear(120, 84)
        self.fc3 = nn.Linear(84, 10)  # 10 output classes for Fashion-MNIST
